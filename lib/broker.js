...
// #### function shutdown
// Gracefully shuts down the broker connections.
function shutdown() {
...
// Destroys the subscriber connection if available
Broker.prototype.destroyChannel = function() {
  if (!!this.channel) return this.store.destroyConnection(this.channel);
}
