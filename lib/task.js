...
Task.prototype.save = function() {
  ...
  return self.factory.getClient().then(function(c) {
...
Task.prototype.failure = function(err) {
  ...
  return this.factory.execute(null, function(c) {
    ...
    .then(function() {
      return self.finalize("failure", null, err, c);
    })
  ...
  //   this.finalize("retrying", 0, err)
  // } else {
  // this.announce("failure");
  // return this.finalize("failure", null, err);
  // }
